...
namespace Presentation.View.Forms.Shipping
{
    public partial class ModelsForm : Form
    {
        ...
        {
            dgv_models.DataSource = shippmentController.SelectAllModels();
        }
        ...
        private void btn_save_model_Click(object sender, EventArgs e)
        {
            ...
            {
                shippmentController.EditModel(txt_model_name.Text, txt_model_id.Text);
            ...
            else
            {
                ...
                {
                    shippmentController.CreateModel(txt_model_name.Text);
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            if (dgv_models.SelectedRows.Count > 0)
            {
                try
                {
                    shippmentController.DeleteBrand(dgv_models.SelectedRows[0].Cells[0].Value.ToString());
                    SelectAllModels();
                }
