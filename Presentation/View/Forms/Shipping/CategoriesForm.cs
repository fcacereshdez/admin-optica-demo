...
namespace Presentation.View.Forms.Shipping
{
    public partial class CategoriesForm : Form
    {
        ...
        {
            dgv_categories.DataSource = shippmentController.SelectAllCategories();
        }
        ...
        private void btn_save_category_Click(object sender, EventArgs e)
        {
            ...
            {
                shippmentController.EditCategory(txt_category_name.Text, txt_category_id.Text);
            ...
            else
            {
                ...
                {
                    shippmentController.CreateCategory(txt_category_name.Text);
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            if (dgv_categories.SelectedRows.Count > 0)
            {
                try
                {
                    shippmentController.DeleteCategory(dgv_categories.SelectedRows[0].Cells[0].Value.ToString());
